...
// const left_xia = document.querySelector('.left_xia');
// const right_xia = document.querySelector('.right_xia');

// left_xia.addEventListener('mouseover', () => {
//     right_xia.style.left = '0'; /* Move Element 2 to the left on hover over Element 1 */
// });

// left_xia.addEventListener('mouseout', () => {
//     right_xia.style.left = '50px'; /* Move Element 2 back to its original position on mouseout of Element 1 */
// });
